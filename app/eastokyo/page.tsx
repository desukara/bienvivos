  ...
  return (
    <div className="mag-page" id="top">
      ...
      <header className="mag-header">
        <div className="mag-header-rail"><p>INDEPENDENT MAGAZINE · TOKYO</p><p>INAUGURAL ISSUE · Nº 01</p><p>01 SEPTEMBER 2026</p></div>
        <nav className="mag-nav" aria-label="Main navigation"><div className="mag-nav-links">{navItems.map((item) => <a key={item.label} href={item.href}>{item.label}</a>)}</div><span>TOKYO · LOUDER THAN IT LOOKS</span></nav>
      ...
      <div id="mag-mobile-menu" className={`mag-mobile-menu ${menuOpen ? "is-open" : ""}`} role="dialog" aria-modal="true" aria-label="Main menu" aria-hidden={!menuOpen}>
        ...
        <nav aria-label="Mobile navigation">{navItems.map((item, index) => <a key={item.label} href={item.href} onClick={closeMenu} tabIndex={menuOpen ? 0 : -1}><span>0{index + 1}</span>{item.label}</a>)}</nav><p>Tokyo, fully alive.</p>
      </div>

      <main id="contenido">
        <section className="mag-cover" id="revista" aria-labelledby="cover-title">
          <div className="mag-cover-media mag-media" aria-hidden="true"><EditorialImage src={coverImage} alt="" sizes="100vw" priority /></div><div className="mag-cover-shade" aria-hidden="true" />
          <div className="mag-cover-grid"><div className="mag-cover-topline"><p>EASTOKYO · TOKYO, FULLY ALIVE</p><p>ART · FOOD · MUSIC · CULTURE · PHOTO</p></div><div className="mag-cover-masthead" aria-hidden="true">EASTOKYO</div><div className="mag-cover-story"><p className="mag-kicker">COVER STORY · P. 08</p><h1 id="cover-title">Tokyo needs <em>more passion</em></h1><p>We love this city. We just want more of it.</p></div><div className="mag-cover-lines" aria-label="Featured stories in this issue"><article className="mag-cover-line"><b>18</b><div><small>ART</small><p>Picasso, through the eyes of Paul Smith</p></div></article><article className="mag-cover-line"><b>30</b><div><small>MUSIC</small><p>Tokyo sounds better after dark.</p></div></article><article className="mag-cover-line"><b>56</b><div><small>PHOTO</small><p>Tokyo is not grey. It never was.</p></div></article></div></div>
        ...
        <section className="mag-section mag-front" id="cultura" aria-labelledby="front-title">
          ...
          <div className="mag-front-grid">
            <article className="mag-front-lead">
              <div className="mag-front-lead-image mag-media"><EditorialImage src="/images/editorial/picasso-paul-smith-desktop.png" alt="A visitor studying Picasso ceramics in the Paul Smith exhibition at The National Art Center, Tokyo" sizes="(max-width: 640px) 100vw, (max-width: 899px) 58vw, 50vw" /></div>
            ...
            <div className="mag-front-stack">
              <article className="mag-front-card"><p className="mag-kicker">ART · LOOK CLOSER</p><h3>The art of paying attention</h3><span>↗</span></article>
              <article className="mag-front-card"><p className="mag-kicker">ART · INSTALLATION</p><h3>Picasso in stripes</h3><span>↗</span></article>
            </div>
        ...
        <section className="mag-section mag-feature" id="comer" aria-labelledby="food-title"><div className="mag-feature-grid"><header className="mag-feature-heading"><p className="mag-kicker">COVER STORY · EAT</p><h2 id="food-title">A Spanish table in the heart of Tokyo</h2><span className="mag-page-number">08</span></header><figure className="mag-feature-image-primary mag-media"><EditorialImage src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=2200&q=95" alt="Restaurant table with plates and glasses" sizes="(max-width: 640px) 100vw, (max-width: 899px) 58vw, 50vw" /><figcaption className="mag-credit">PHOTOGRAPHY · EASTOKYO / P. 08</figcaption></figure><figure className="mag-feature-image-detail mag-media"><EditorialImage src={foodDetailImage} alt="Shared table with colorful plates and conversation" sizes="(max-width: 640px) 100vw, (max-width: 899px) 42vw, 28vw" /><figcaption className="mag-credit">AFTER DINNER · DETAIL / P. 11</figcaption></figure><div className="mag-feature-copy"><p className="mag-deck">A restaurant, a long conversation, and plates filled with memory.</p><p className="mag-feature-columns">We’re not here just to eat. A good table can be a way of finding your way home. In a city where dinner can move quickly, this place asks you to stay: order another glass, keep the conversation going, and let the night take its time. The food matters, of course. But so do the stories that unfold between one plate and the next.</p></div><blockquote className="mag-feature-pullquote">“A table is more than furniture. It’s where food becomes conversation, and strangers stop feeling like strangers.”<span>EASTOKYO · COVER STORY</span></blockquote></div></section>
        <section className="mag-passion-strip" aria-label="Editorial statement"><p>Eat. Dance. Talk. <em>Stay a little longer.</em></p></section>
        <section className="mag-section mag-night" id="musica" aria-labelledby="night-title"><div className="mag-night-sideword" aria-hidden="true">NIGHT</div><div className="mag-night-grid"><header className="mag-night-heading"><p className="mag-kicker">MUSIC · P. 30</p><h2 id="night-title">Tokyo was never quiet.</h2><p>You just have to know where to listen. We follow the clubs, sounds and late-night obsessions setting the city’s pulse.</p></header><figure className="mag-night-image-main mag-media"><EditorialImage src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=2000&q=94" alt="Singer performing under concert lights" sizes="(max-width: 640px) 100vw, (max-width: 899px) 62vw, 58vw" /><figcaption className="mag-credit">LIVE · TOKYO / 01:14</figcaption></figure><div className="mag-night-copy"><p className="mag-deck">Tokyo sounds better after dark.</p><p>Somewhere between the last train and the first, the city changes register. Basements fill, speakers warm up, and rooms no bigger than living rooms become their own worlds.</p><p>We’re interested in those rooms—and in the people keeping them alive.</p></div><blockquote className="mag-night-quote">“The best nights are the ones you never planned.”</blockquote></div></section>
        <section className="mag-section mag-culture" aria-labelledby="culture-title"><div className="mag-rule-heading"><h2>CULTURE · P. 42</h2></div><div className="mag-culture-grid"><header><p className="mag-kicker">ESSAY · TABLE TALK</p><h2 id="culture-title">The best part starts after dinner.</h2><p className="mag-deck">The plates are empty. Nobody leaves. That’s when things get interesting.</p></header><figure className="mag-culture-image mag-media"><EditorialImage src="https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=1800&q=94" alt="Friends sharing food and conversation at a table" sizes="(max-width: 640px) 100vw, (max-width: 899px) 60vw, 46vw" /><figcaption className="mag-credit">TOKYO · AFTER DINNER</figcaption></figure><div className="mag-culture-body"><p>Tokyo is exceptionally good at the beginning of an evening. Reservations are precise. Trains arrive on time. The first drink appears almost immediately.</p><p>But our favorite part comes later, once the evening has stopped behaving itself.</p><p>The table becomes crowded with empty glasses. Somebody orders something nobody needs. The conversation takes a turn that could never have been scheduled.</p><p>That is the Tokyo we want more of.</p></div><p className="mag-culture-bigword" aria-hidden="true">STAY</p></div></section>
        <section className="mag-section mag-photo" id="foto" aria-labelledby="photo-title"><header className="mag-photo-heading"><p className="mag-kicker">PHOTO ESSAY · P. 56</p><h2 id="photo-title">Tokyo is not grey.</h2><p>Color is everywhere. You just have to stop treating the city like background.</p></header><div className="mag-photo-grid">{photoEssayImages.map((image, index) => <figure key={image.src} className={`mag-photo-${index + 1} mag-media`}><EditorialImage src={image.src} alt={image.label} sizes={index === 0 || index === 5 ? "(max-width: 640px) 100vw, 62vw" : "(max-width: 640px) 100vw, 31vw"} /><figcaption className="mag-credit">0{index + 1} · {image.label.toUpperCase()}</figcaption></figure>)}</div></section>
        <section className="mag-section mag-index" aria-labelledby="index-title"><div className="mag-index-header"><p className="mag-kicker">THE BACK PAGES · P. 64—79</p><h2 id="index-title">One more thing.</h2></div><figure className="mag-index-feature mag-media"><EditorialImage src={indexFeatureImage} alt="Tokyo street scene at night" sizes="100vw" /><figcaption className="mag-credit">TOKYO · KEEP LOOKING</figcaption></figure><div className="mag-index-grid">{indexStories.map((story) => <article key={story.page}><div className="mag-index-thumb mag-media"><EditorialImage src={story.image} alt="" sizes="(max-width: 640px) 100vw, 25vw" /></div><strong>{story.page}</strong><small>{story.section}</small><h3>{story.title}</h3><p>{story.copy}</p></article>)}</div></section>
      </main>
