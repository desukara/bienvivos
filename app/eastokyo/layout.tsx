...
export const metadata: Metadata = {
  ...
  title: { absolute: "EASTOKYO — Tokyo, fully alive" },
  ...
  openGraph: {
    ...
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "EASTOKYO — Tokyo, fully alive" }],
  },
  twitter: { card: "summary_large_image", title: "EASTOKYO — Tokyo, fully alive", description: "An independent magazine about Tokyo culture and city life.", images: ["/opengraph-image"] },
};
